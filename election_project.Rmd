...
Let's try to model a binary outcome- Run a model to predict what caused a county to switch to republican in 2016- a simple y/n.
...
AUC looks good- .92 on our model of predicted flips.  What's important to note isn't really the model- not too much point in trying to predict what already happened, but we can learn a lot from creating this model- specifically, what are the biggest influencers in a county switching from 2012-2016? 
